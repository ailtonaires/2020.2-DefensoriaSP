...
|13|Você já utilizou o atendimento virtual de chatbot da Defensoria Pública?|[ ] Sim<br/>[x] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 15|
|14|Você conseguiu ler o material institucional através do chatbot?|[ ] Sim<br/>[ ] Não|
|15|Você já obteve informações sobre a instituição da Defensoria Pública pelo website?|[ ] Sim<br/>[x] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 22|
...
|22|Dentro do website, você encontrou alguma dificuldade ou problema ao utilizá-lo?|[ ] Sim<br/>[x] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 25|
...
|25|Você sentiu falta de algo ao utilizar o website?|[ ] Sim<br/>[x] Não<br/>⚠️ Caso a resposta seja "Não", finalize a entrevista|
...
|Número|Pergunta|Estrutura da Resposta|
|------|--------|---------------------|
|1|Qual seu nome?|Marcos Souza|
|2|Qual sua idade|26 anos|
|3|Qual seu gênero|[x] Masculino<br/>[ ] Feminino<br/>[ ] Não binário<br/>[ ] Outro, qual?|
|5|Você já utilizou o website da Defensoria Pública do estado de São Paulo?|[x] Sim<br/>[ ] Não<br/>⚠️ Caso a resposta seja "Não", finalize a entrevista|
|6|Você já buscou por informações de atendimento da Defensoria Pública no website?|[x] Sim<br/>[ ] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 13|
||<strong>Observações para as próximas perguntas abertas:</strong><br/>Responda as perguntas identificando os menus em que foi necessário cliques para chegar à informação, não é necessário identificar todos os detalhes do fluxo, apenas o suficiente para reprodução através da resposta||
|7|Dentro do website, como você verifica os locais de atendimento?|1. Entra na Home do site. </br>2. Clica em 'Locais de Atendimento' localizado em um menu central da página.</br>3. Recebe atendimento online. |
|8|Dentro do website, como você acessa os serviços da Defensoria?|1. Entra na Home do site.</br>2. Clica em 'Atendimento' no menu lateral.</br>3. Clica em 'Nossos Serviços' no menu lateral.</br>4. Visualiza os serviços da Defensoria.|
|9|Dentro do website, como você verifica os documentos necessários?|1. Entra na Home do site.</br>2. Clica em 'Atendimento' no menu lateral.</br>3. Clica em 'Documentos Necessários' no menu lateral.</br>4. Procura qual a situação que se encaixa. </br>5. Baixa um PDF com os documentos necessários.|
|10|Dentro do website, como você acessa aos planfletos informativos?|Não conseguiu encontrar.|
|11|Dentro do website, como você acessa às dúvidas frequentes?|1. Entra na Home do site.</br>2. Clica em 'Atendimento' no menu lateral.</br>3. Clica em 'Dúvidas Frequentes' no menu lateral.</br>4. Visualiza as dúvidas frequentes da Defensoria.|
|12|Dentro do website, como você entra em contato com a Defensoria?|1. Entra na Home do site.</br>2. Clica em 'Atendimento' no menu lateral.</br>3. Clica em 'Fale Conosco' no menu lateral.</br>4. Preenche formulários para entrar em contato.|
|13|Você já utilizou o atendimento virtual de chatbot da Defensoria Pública?|[ ] Sim<br/>[x] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 15|
|14|Você conseguiu ler o material institucional através do chatbot?|[ ] Sim<br/>[ ] Não|
|15|Você já obteve informações sobre a instituição da Defensoria Pública pelo website?|[x] Sim<br/>[ ] Não<br/>⚠️ Caso a resposta seja "Não", pule para a pergunta 22|
|16|Dentro do website, como você acessa à seção "Quem Somos" do website?|1. Entra na Home do site.</br>2. Clica em 'Institucional' no menu lateral.</br>3. Visualiza um texto sobre o assunto 'Quem somos'.|
|17|Dentro do website, como você acessa às áreas de atuação da Defensoria?|1. Entra na Home do site.</br>2. Clica em 'Institucional' no menu lateral.</br>3. Clica no menu lateral na opção de 'Áreas de Atuação'.</br>4. Visualiza as áreas de atuação.|
|18|Dentro do website, como você acessa à seção "Saiba Mais" do website?|1. Entra na Home do site.</br>2. Clica em 'Institucional' no menu lateral.</br>3. Clica no menu lateral na opção de 'Saiba Mais'.</br>4. Visualiza a parte de Saiba Mais do site.|
|19|Dentro do website, como você verifica os defensores da Defensoria?|1. Entra na Home do site.</br>2. Clica em 'Institucional' no menu lateral.</br>3. Clica no menu lateral na opção de 'Defensores'.</br>4. Visualiza os Defensores existentes.|
|20|Dentro do website, como você verifica os órgãos da Defensoria?|1. Entra na Home do site.</br>2. Clica em 'Institucional' no menu lateral.</br>3. Clica no menu lateral na opção de 'Órgãos'.</br>4. Visualiza os órgãos e pode ver maiores informações sobre o assunto.|
